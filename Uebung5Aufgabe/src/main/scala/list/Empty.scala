...
case object Empty extends IntList{
  ...
  def map(mapFun:(Int)=>Int): IntList = Empty
  def filter(filterFun:Int=>Boolean):IntList= Empty
  def foldLeft(base:Int)(reduceFun:(Int,Int)=>Int):Int= base
  def foldRight(base:Int)(reduceFun:(Int,Int)=>Int):Int= base
}